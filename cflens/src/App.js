  ...
  return (
    <div>
      ...
      <div className="row1">
        ...
        <p>
            The chart below shows the submission history of a user over a year. 
      ...
      <div className="row1">
        ...
        <br /><br />
        <a className="btn btn-primary" href="https://drive.google.com/file/d/1fOF7n-gwvoexxcFuZX9yahGQRTJVwfo4/view?usp=drive_link" target="_blank" rel="noopener noreferrer" style={{padding: '12px 24px', fontSize: '18px', borderRadius: '8px', backgroundColor: '#64a19d', color: '#ffffff', textDecoration: 'none'}}>Watch Demo Video</a>
      <br /><br /><br /><br /><br /><br />
        </div>
        </center>
    </div>
